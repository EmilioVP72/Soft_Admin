...
class UpdateGeneralDepartmentRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'g_departament' => 'sometimes|required|string|max:255',
            'g_descripcion' => 'sometimes|required|string',
            'fkl_id_tienda' => 'sometimes|required|integer|exists:stores,id_store',
        ];
    }
