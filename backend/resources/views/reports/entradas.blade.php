...
<body class="p-8 max-w-5xl mx-auto">
    ...
    <section class="grid grid-cols-2 gap-6 mb-8 w-2/3">
        ...
        <div class="bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm relative overflow-hidden">
            <p class="text-sm text-blue-600 font-semibold mb-1 uppercase tracking-wide">Total Monto Entrada</p>
            <p class="text-3xl font-bold text-blue-800">${{ number_format($monto_total, 2) }}</p>
        </div>
    </section>
